...
class TestIssuesViews(TestBase):
    ...
    def test_workshop_issues_past(self) -> None:
    ...
    def test_workshop_issues_active(self) -> None:
    ...
    def test_workshop_issues_no_attendance(self) -> None:
        ...
        attendance.task_set.create(person=Person.objects.all()[0], role=self.instructor_role)
        ...
        no_attendance.task_set.create(person=Person.objects.all()[0], role=self.instructor_role)
        ...
        no_attendance_unresponsive.task_set.create(person=Person.objects.all()[0], role=self.instructor_role)
    ...
    def test_workshop_issues_no_location(self) -> None:
        ...
        location.task_set.create(person=Person.objects.all()[0], role=self.instructor_role)
        ...
        no_location.task_set.create(person=Person.objects.all()[0], role=self.instructor_role)

        rv = self.client.get(self.url)
        self.assertNotIn(location, rv.context["events"])
        self.assertIn(no_location, rv.context["events"])

    def test_workshop_issues_wrong_dates(self) -> None:
        ...
        okay.task_set.create(person=Person.objects.all()[0], role=self.instructor_role)
        ...
        invalid_dates.task_set.create(person=Person.objects.all()[0], role=self.instructor_role)

        rv = self.client.get(self.url)
        self.assertNotIn(okay, rv.context["events"])
        self.assertIn(invalid_dates, rv.context["events"])

    def test_workshop_issues_no_instructors(self) -> None:
        ...
        instructor.task_set.create(person=Person.objects.all()[0], role=self.instructor_role)
