...
urlpatterns = [
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "add/", views.OrganizationCreate.as_view(), name="organization_add"
                ),
            ]
        ),
    ),
    path(
        ...
        include(
            [
                path(
                    "", views.OrganizationDetails.as_view(), name="organization_details"
                ),
                path(
                    "edit/",
                ...
                path(
                    "delete/",
                    views.OrganizationDelete.as_view(),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "members/",
                    views.MembershipMembers.as_view(),
                    name="membership_members",
                ),
                path(
                    "delete/",
                    views.MembershipDelete.as_view(),
    ...
    # sponsorships
    path(
        "sponsorships/add/", views.SponsorshipCreate.as_view(), name="sponsorship_add"
    ),
    path(
        "sponsorship/<int:pk>/delete/",
        views.SponsorshipDelete.as_view(),
