    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generic_relation_m2m', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveIntegerField(), default=list, size=None)),
                ('award', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='workshops.Award')),
                ('config', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='communityroles.CommunityRoleConfig')),
                ('inactivation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='communityroles.CommunityRoleInactivation')),
                ('membership', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='workshops.Membership')),
