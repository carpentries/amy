# Generated by Django 2.2.24 on 2021-12-29 16:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(blank=False, choices=[('nonprofit', 'I am with a government site, university, or other nonprofit. I understand the workshop fee as listed on The Carpentries website and agree to follow through on The Carpentries invoicing process.'), ('forprofit', 'I am with a corporate or for-profit site. I understand the costs for for-profit organisations are four times the price for not-for-profit organisations.'), ('member', 'I am with a Member organisation so the workshop fee does not apply (instructor travel costs will still apply for in-person workshops).'), ('waiver', 'I am requesting financial support for the workshop fee (instructor travel costs will still apply for in-person workshops)')], default=None, help_text="<a href='' target='_blank' rel='noreferrer nofollow'>The Carpentries website workshop fee listing.</a>", max_length=20, null=False, verbose_name='Which of the following applies to your payment for the administrative fee?'),
        ),
        migrations.AlterField(
            model_name='workshopinquiryrequest',
