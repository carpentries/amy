...
urlpatterns = [
    ...
    url(r'^workshop_request/(?P<request_id>\d+)/', include([
        ...
        url(r'^assign/$', views.WorkshopRequestAssign.as_view(), name='workshoprequest_assign'),
        url(r'^assign/(?P<person_id>[\w\.-]+)/$', views.WorkshopRequestAssign.as_view(), name='workshoprequest_assign'),
    ])),

    # deprecated: old swc/dc workshop requests
    url(r'^eventrequests/$', deprecated_views.AllEventRequests.as_view(), name='all_eventrequests'),
    url(r'^eventrequest/(?P<request_id>\d+)/', include([
        ...
        url(r'^assign/$', deprecated_views.EventRequestAssign.as_view(), name='eventrequest_assign'),
        url(r'^assign/(?P<person_id>[\w\.-]+)/$', deprecated_views.EventRequestAssign.as_view(), name='eventrequest_assign'),
    ])),
    ...
    url(r'^dc_selforganized_request/(?P<request_id>\d+)/', include([
        ...
        url(r'^assign/$', deprecated_views.DCSelfOrganizedEventRequestAssign.as_view(), name='dcselforganizedeventrequest_assign'),
        url(r'^assign/(?P<person_id>[\w\.-]+)/$', deprecated_views.DCSelfOrganizedEventRequestAssign.as_view(), name='dcselforganizedeventrequest_assign'),
    ])),
    ...
    url(r'^submission/(?P<submission_id>\d+)/', include([
        ...
        url(r'^assign/$', deprecated_views.EventSubmissionAssign.as_view(), name='eventsubmission_assign'),
        url(r'^assign/(?P<person_id>[\w\.-]+)/$', deprecated_views.EventSubmissionAssign.as_view(), name='eventsubmission_assign'),
    ])),
