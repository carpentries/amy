...
class TestWorkshopInquiryExternalForm(TestBase):
    ...
    def test_fields_presence(self):
        ...
        fields_right = set([
            ...
            "location", "country",
            "routine_data", "routine_data_other",
            ...
            "institution_restrictions", "institution_restrictions_other",
            "public_event", "public_event_other",
            "additional_contact",
            "carpentries_info_source", "carpentries_info_source_other",
            "user_notes",
    ...
    def test_request_added(self):
        ...
        rv = self.client.post(reverse('workshop_inquiry'), data,
                              follow=True)
