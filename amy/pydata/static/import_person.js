function import_from_url(url) {
  return $.get("/workshops/persons/import/", {'url': url}, function(data) {
    $("#person_import_url").parent().removeClass('has-error');
...
$('#import_person_form').submit(function(event) {
  ...
  .fail(function(data) {
    ...
    $("#person_import_url").parent().addClass('has-error');
