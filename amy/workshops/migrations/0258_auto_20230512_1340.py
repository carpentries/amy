# Generated by Django 3.2.18 on 2023-05-12 13:40
...
def reverse_rename_discussion_to_welcome_session(apps, schema_editor) -> None:
    TrainingRequirement = apps.get_model("workshops", "TrainingRequirement")
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            ...
            reverse_rename_discussion_to_welcome_session,
        )
    ]
