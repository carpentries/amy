# Generated by Django 2.2.18 on 2021-05-16 19:21
    ...
    operations = [
        migrations.AddField(
            ...
            field=django.contrib.postgres.fields.ArrayField(
                ...
                default=list,
                help_text='Number of days the agreement was extended with. The field stores multiple extensions. The agreement end date has been moved by a cumulative number of days from this field.',
                size=None,
            ),
            preserve_default=False,
        ),
        migrations.RunPython(move_extensions, undo_extensions),
        migrations.RemoveField(model_name='membership', name='extended'),
    ]
