    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('state', models.CharField(choices=[('scheduled', 'Scheduled'), ('locked', 'Locked'), ('running', 'Running'), ('succeeded', 'Succeeded'), ('failed', 'Failed')], default='scheduled', max_length=30)),
                ...
                ('cc_header', django.contrib.postgres.fields.ArrayField(base_field=models.EmailField(max_length=254), size=None, verbose_name='CC (header)')),
                ('bcc_header', django.contrib.postgres.fields.ArrayField(base_field=models.EmailField(max_length=254), size=None, verbose_name='BCC (header)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_before', models.CharField(blank=True, choices=[('scheduled', 'Scheduled'), ('locked', 'Locked'), ('running', 'Running'), ('succeeded', 'Succeeded'), ('failed', 'Failed')], editable=False, max_length=30, null=True)),
                ('state_after', models.CharField(choices=[('scheduled', 'Scheduled'), ('locked', 'Locked'), ('running', 'Running'), ('succeeded', 'Succeeded'), ('failed', 'Failed')], editable=False, max_length=30)),
