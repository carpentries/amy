...
class TestMembershipQuarterlyEmailsStrategy(TestCase):
    ...
    @patch("emails.actions.membership_quarterly_emails.ScheduledEmail")
...
class TestRunMembershipQuarterlyEmailsStrategy(TestCase):
    ...
    @patch("emails.actions.membership_quarterly_emails.membership_quarterly_6_months_signal")
    ...
    @patch("emails.actions.membership_quarterly_emails.membership_quarterly_6_months_update_signal")
    ...
    @patch("emails.actions.membership_quarterly_emails.membership_quarterly_6_months_cancel_signal")
