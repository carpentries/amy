...
class TestRunAskForWebsiteStrategy(TestCase):
    @patch("emails.actions.ask_for_website.ask_for_website_signal")
    ...
    @patch("emails.actions.ask_for_website.ask_for_website_update_signal")
    ...
    @patch("emails.actions.ask_for_website.ask_for_website_cancel_signal")
