...
CREATE TABLE "workshops_person" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "personal" varchar(100) NOT NULL, "middle" varchar(100) NULL, "family" varchar(100) NOT NULL, "active" bool NULL, "airport_id" integer NULL REFERENCES "workshops_airport" ("id"), "gender" varchar(1) NULL, "github" varchar(40) NULL UNIQUE, "twitter" varchar(40) NULL UNIQUE, "url" varchar(100) NULL, "slug" varchar(100) NULL, "email" varchar(100) NULL UNIQUE);
