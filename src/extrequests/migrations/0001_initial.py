...
def update_contenttypes(apps, schema_editor):
    ...
    ContentType.objects.filter(app_label="workshops", model__in=model_names).update(app_label="extrequests")
    ...
    state_operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "organization",
                    models.CharField(max_length=255, verbose_name="University or organization affiliation"),
                ),
                (
                    "instructor_status",
                    models.CharField(
                        ...
                        choices=[
                            ("", "None"),
                            ("incomplete", "Have gone through instructor training, but haven't yet completed checkout"),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("y", "Yes"), ("n", "No"), ("u", "Unsure"), ("", "Other (enter below)")],
                        max_length=1,
                        verbose_name="Is your organization a Data Carpentry or Software Carpentry Partner",
                    ),
                ),
                (
                    "is_partner_other",
                    models.CharField(
                        blank=True, default="", max_length=100, verbose_name="Other (is your organization a Partner?)"
                    ),
                ),
                (
                    "location",
                    models.CharField(help_text="City, Province or State", max_length=255, verbose_name="Location"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="If the workshop is to be associated with a conference or meeting, which one?",
                        max_length=100,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("per_participant", "I will contribute $25/participant through registration fees"),
                        ...
                        help_text="Self-organized workshops for non-Partner organizations are $500 or $25/participant"
                        ' for a workshop licensing fee (<a href="http://www.datacarpentry.org/self-organized-'
                        'workshops/">http://www.datacarpentry.org/self-organized-workshops/</a>). Fee waivers are '
                        "available and generally granted upon request.",
                        max_length=40,
                ...
                (
                    "fee_waiver_reason",
                    models.CharField(
                        blank=True, default="", max_length=255, verbose_name="Reason for requesting a fee waiver"
                    ),
                ),
                (
                    "handle_registration",
                    models.BooleanField(
                        default=False, verbose_name="I confirm that I will handle registration for this workshop"
                    ),
                ),
                (
                    "distribute_surveys",
                    models.BooleanField(
                        default=False,
                        verbose_name="I confirm that I will distribute the Data Carpentry surveys to workshop "
                        "participants",
                    ),
                ),
                (
                    "follow_code_of_conduct",
                    models.BooleanField(
                        default=False, verbose_name="I confirm that I will follow the Data Carpentry Code of Conduct"
                    ),
                ),
                (
                    "assigned_to",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="extrequests.DataAnalysisLevel",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "preferred_date",
                    models.CharField(
                        help_text="Please indicate when you would like to run the workshop. A range of at least a "
                        "month is most helpful, although if you have specific dates you need the workshop, we will "
                ...
                (
                    "workshop_type",
                    models.CharField(
                        choices=[("swc", "Software-Carpentry"), ("dc", "Data-Carpentry")], default="swc", max_length=40
                    ),
                ),
                (
                    "approx_attendees",
                    models.CharField(
                        ...
                        "instructors your workshop will need.Each workshop must have at least two instructors.",
                        max_length=40,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=40,
                        verbose_name="We currently have developed or are developing workshops focused on four "
                        "types of data. Please let us know which workshop would best suit your needs.",
                    ),
                ),
                (
                    "data_types_other",
                    models.CharField(blank=True, max_length=100, verbose_name="Other data domains for the workshop"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "self-organized",
                                "Self-organized: no fee (please let us know if you wish to make a donation)",
                            ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Waiver's of the administrative fee are available on a needs basis. If you are "
                        "interested in submitting a waiver application please indicate here.",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="What else do you want us to know about your workshop? About your attendees? "
                        "About you?",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "affiliation",
                    models.CharField(
                        help_text="What university, company, lab, or other organization are you affiliated with "
                        "(if any)?",
                        max_length=100,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        'target="_blank">http://www.airportcodes.aero/</a>) to tell us where you\'re located.',
                        max_length=3,
                ...
                (
                    "occupation_other",
                    models.CharField(
                        blank=True, default="", max_length=100, verbose_name="Other occupation/career stage"
                    ),
                ),
                (
                    "github",
                    src.workshops.fields.NullableGithubUsernameField(
                        blank=True,
                        default="",
                ...
                (
                    "gender",
                    models.CharField(
                        choices=[("U", "Prefer not to say"), ("F", "Female"), ("M", "Male"), ("O", "Other:")],
                        default="U",
                        max_length=1,
                    ),
                ),
                ...
                (
                    "domains_other",
                    models.CharField(blank=True, default="", max_length=255, verbose_name="Other areas of expertise"),
                ),
                (
                    "lessons_other",
                    models.CharField(
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text='Allow to contact from The Carpentries according to the <a href="https://docs.'
                        'carpentries.org/topic_folders/policies/privacy.html" target="_blank">Privacy Policy</a>.',
                    ),
                ),
                (
                    "publish_profile",
                    models.BooleanField(
                        default=False,
                        help_text="Allow to post your name and any public profile you list (website, Twitter) on our "
                        "instructors website. Emails will not be posted.",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        limit_choices_to=models.Q(_negated=True, name__startswith="Don't know yet"),
                        to="workshops.KnowledgeDomain",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                to="extrequests.DCWorkshopDomain",
        ...
        migrations.AddField(
            ...
            name="topics",
            field=models.ManyToManyField(
                help_text="A Data Carpentry workshop must include a Data Carpentry lesson on data organization and "
                'three other modules in the same domain from the Data Carpentry curriculum (see <a href="'
                'http://www.datacarpentry.org/workshops/">http://www.datacarpentry.org/workshops/</a>). If '
                "you do want to include materials not in our curriculum, please note that below and we'll "
                "get in touch.",
                to="extrequests.DCWorkshopTopic",
