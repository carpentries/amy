...
from src.extrequests.views import (
...
class InitialWRFTestMixin[T: Model](TestCase):
    view_class: type[AMYCreateAndFetchObjectView[Event, T, EventCreateForm]]

    def setUpOther(self) -> T:
