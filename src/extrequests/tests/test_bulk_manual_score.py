...
class CSVBulkUploadTestBase(TestBase):
    ...
    def make_csv_data(self) -> str:
        return f"""request_id,score_manual,score_notes
{self.tr1.pk},-10,"This person did bad."
{self.tr2.pk},0,"This person did neutral."
{self.tr3.pk},10,"This person exceeded ."
{self.tr4.pk},0,This person did OK."""
