...
from src.consents.models import (
    Consent,
    Term,
    TermEnum,
    TermOption,
...
class TestMatchingTrainingRequestAndDetailedView(TestBase):
    ...
    def test_matching_with_existing_account_works(self) -> None:
        ...
        for key, value in data_expected.items():
            self.assertEqual(getattr(self.ironman, key), value, f"Attribute: {key}")
    ...
    def test_matching_with_new_account_works(self) -> None:
        ...
        for key, value in data_expected.items():
            self.assertEqual(getattr(req.person, key), value, f"Attribute: {key}")
...
class TestTrainingRequestTemplateTags(TestBase):
    def test_pending_request(self) -> None:
        self._test(state="p", expected="badge text-bg-warning")

    def test_accepted_request(self) -> None:
        self._test(state="a", expected="badge text-bg-success")

    def test_discarded_request(self) -> None:
        self._test(state="d", expected="badge text-bg-danger")
...
class TestTrainingRequestMerging(TestBase):
    ...
    def setUp(self) -> None:
        ...
        self.ca = Comment.objects.create(
            ...
            submit_date=datetime.now(tz=UTC),
        ...
        self.first_req_may_contact_consent.created_at = datetime(2023, 4, 10, tzinfo=UTC)
        ...
        self.second_req_may_contact_consent.created_at = datetime(2023, 4, 11, tzinfo=UTC)
        ...
        self.third_req_may_contact_consent.created_at = datetime(2023, 4, 12, tzinfo=UTC)
        ...
        self.first_req_privacy_policy_consent.created_at = datetime(2023, 4, 12, tzinfo=UTC)
        ...
        self.second_req_privacy_policy_consent.created_at = datetime(2023, 4, 11, tzinfo=UTC)
        ...
        self.third_req_privacy_policy_consent.created_at = datetime(2023, 4, 10, tzinfo=UTC)
        ...
        self.first_req_public_profile_consent.created_at = datetime(2023, 4, 11, tzinfo=UTC)
        ...
        self.second_req_public_profile_consent.created_at = datetime(2023, 4, 10, tzinfo=UTC)
        ...
        self.third_req_public_profile_consent.created_at = datetime(2023, 4, 12, tzinfo=UTC)
        ...
        self.url_1 = f"{base_url}?{query_1}"
        self.url_2 = f"{base_url}?{query_2}"
    ...
    def test_merging_basic_attributes(self) -> None:
        ...
        assertions = {
            ...
            "airport_iata": self.first_req.airport_iata,
            ...
            "nonprofit_teaching_experience": self.first_req.nonprofit_teaching_experience,  # noqa: E501
            "previous_training": self.first_req.previous_training,
            "previous_training_other": self.first_req.previous_training_other,
            "previous_training_explanation": self.first_req.previous_training_explanation,  # noqa: E501
            "previous_experience": self.first_req.previous_experience,
            "previous_experience_other": self.first_req.previous_experience_other,
            "previous_experience_explanation": self.first_req.previous_experience_explanation,  # noqa: E501
            "programming_language_usage_frequency": self.first_req.programming_language_usage_frequency,  # noqa: E501
            "checkout_intent": self.first_req.checkout_intent,
            "teaching_intent": self.first_req.teaching_intent,
            "teaching_frequency_expectation": self.first_req.teaching_frequency_expectation,  # noqa: E501
            "teaching_frequency_expectation_other": self.first_req.teaching_frequency_expectation_other,  # noqa: E501
            "max_travelling_frequency": self.first_req.max_travelling_frequency,
            "max_travelling_frequency_other": self.first_req.max_travelling_frequency_other,  # noqa: E501
