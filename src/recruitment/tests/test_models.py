...
from src.recruitment.models import InstructorRecruitment, RecruitmentPriority
from src.workshops.models import Event, Organization, Tag


class TestInstructorRecruitment(TestCase):
    @patch("src.recruitment.models.date")
    ...
    def test_manager_annotate_with_priority__not_online(self, mock_date: MagicMock) -> None:
        ...
        # event.tags.add(Tag.objects.get(name="Circuits"))
