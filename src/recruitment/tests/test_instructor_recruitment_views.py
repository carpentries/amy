...
from src.recruitment.filters import InstructorRecruitmentFilter
from src.recruitment.forms import (
...
from src.recruitment.views import (
...
class TestInstructorRecruitmentCreateView(TestBase):
    ...
    def test_get(self) -> None:
        ...
        view = InstructorRecruitmentCreate(kwargs={"event_id": event.pk})
        # Act
        with mock.patch("src.recruitment.views.super") as mock_super:
...
class TestInstructorRecruitmentAddSignup(TestBase):
    ...
    def test_get_object(self) -> None:
        ...
        # Act
        with mock.patch("src.recruitment.views.InstructorRecruitment") as mock_recruitment:
            view.get_object()
        # Assert
    ...
    def test_get_success_url(self) -> None:
        ...
        for url, redirect in url_redirect.items():
            ...
            pk = 120000
            view = InstructorRecruitmentAddSignup(kwargs={"pk": pk})
            with mock.patch("src.recruitment.views.InstructorRecruitment"):
                view.post(request)  # type: ignore[arg-type]
            # Act
...
class TestInstructorRecruitmentSignupChangeState(TestBase):
    ...
    def test_get_object(self) -> None:
        ...
        # Act
        with mock.patch("src.recruitment.views.InstructorRecruitmentSignup") as mock_signup:
            view.get_object()
        # Assert
    ...
    def test_get_success_url(self) -> None:
        ...
        for url, redirect in url_redirect.items():
            ...
            pk = 120000
            view = InstructorRecruitmentSignupChangeState(kwargs={"pk": pk})
            with mock.patch("src.recruitment.views.InstructorRecruitmentSignup"):
                view.post(request)  # type: ignore[arg-type]
            # Act
            result = view.get_success_url()
            # Assert
...
class TestInstructorRecruitmentChangeState(TestBase):
    ...
    @mock.patch("src.recruitment.views.host_instructors_introduction_strategy")
