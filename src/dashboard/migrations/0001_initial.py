...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django_countries.fields.CountryField(
                        max_length=752, multiple=True, verbose_name="Countries to match this criterium"
                    ),
                ),
        ...
        migrations.RunPython(
            add_initial_criteria,  # forward
            remove_initial_criteria,
        ),  # backward
    ]
