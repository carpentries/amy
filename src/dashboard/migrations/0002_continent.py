...
def add_initial_continents(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    data = [
        ...
        ("Antarctica", "AQ,HM"),
        ("Australia / Oceania", "AU,FM,FJ,KI,MH,NR,NZ,PW,PG,WS,SB,TO,TV,VU,CK,NU,AS,PF,GU,NC,NF,MP,PN,TK,WF,UM"),
    ]
    for datum in data:
...
def remove_initial_continents(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    Continent = apps.get_model("dashboard", "Continent")
    names = ["Africa", "Asia", "Europe", "North America", "South America", "Antarctica", "Australia/Oceania"]
    for name in names:
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    django_countries.fields.CountryField(
                        max_length=752, multiple=True, verbose_name="Countries in this continent"
                    ),
                ),
            ],
            options={
        ...
        migrations.RunPython(
            add_initial_continents,  # forward
            remove_initial_continents,
        ),  # backward
    ]
