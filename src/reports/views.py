...
from src.fiscal.filters import MembershipTrainingsFilter
from src.workshops.base_views import AMYListView
...
class WorkshopIssues(OnlyForAdminsMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        assignment_form = AssignmentForm(self.request.GET)
        ...
        events = events.prefetch_related(
            Prefetch(
                ...
                .filter(
                    ...
                    Q(role__name="host") | Q(role__name="organizer") | Q(role__name="instructor")
                )
                .filter(
...
class ReviewDuplicatePersons(OnlyForAdminsMixin, View):
    def post(self, request: HttpRequest, *args: Any, **kwargs: Any) -> HttpResponse:
        if "person_id" in request.POST:
            ...
            messages.success(request, f"Successfully marked {number} persons as reviewed.")
