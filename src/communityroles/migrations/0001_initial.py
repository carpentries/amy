        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "award_badge_limit",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="workshops.Badge"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "award",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to="workshops.Award"
                    ),
                ),
                (
                    "config",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="communityroles.CommunityRoleConfig"
                    ),
                ),
                (
                    "inactivation",
