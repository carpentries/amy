...
def text_to_body(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
...
def body_to_text(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    EmailTemplate = apps.get_model("autoemails", "EmailTemplate")
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.TextField(
                ...
                "'https://docs.djangoproject.com/en/dev/topics/templates/#the-django-template-language'>Django "
                "templates language</a>.",
