...
from src.emails.signals import INSTRUCTOR_TRAINING_APPROACHING_SIGNAL_NAME
...
class TestRunInstructorTrainingApproachingStrategy(TestCase):
    @patch(
        "src.emails.actions.instructor_training_approaching.instructor_training_approaching_signal",
    )
    ...
    @patch(
        "src.emails.actions.instructor_training_approaching.instructor_training_approaching_update_signal",
    )
    ...
    @patch(
        "src.emails.actions.instructor_training_approaching.instructor_training_approaching_cancel_signal",
    )
