...
from src.emails.actions.instructor_confirmed_for_workshop import (
...
from src.emails.signals import INSTRUCTOR_CONFIRMED_FOR_WORKSHOP_SIGNAL_NAME
...
class TestRunInstructorConfirmedForWorkshopStrategy(TestCase):
    ...
    @patch("src.emails.actions.instructor_confirmed_for_workshop.instructor_confirmed_for_workshop_signal")
    def test_strategy_calls_create_signal(
        self,
        mock_instructor_confirmed_for_workshop_signal: MagicMock,
    ) -> None:
        # Arrange
    ...
    @patch("src.emails.actions.instructor_confirmed_for_workshop.instructor_confirmed_for_workshop_update_signal")
    ...
    @patch("src.emails.actions.instructor_confirmed_for_workshop.instructor_confirmed_for_workshop_cancel_signal")
    ...
    def test_invalid_strategy_no_signal_called(
        self,
        mock_instructor_confirmed_for_workshop_cancel_signal: MagicMock,
        mock_instructor_confirmed_for_workshop_update_signal: MagicMock,
        mock_instructor_confirmed_for_workshop_signal: MagicMock,
