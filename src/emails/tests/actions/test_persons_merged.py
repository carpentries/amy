...
class TestPersonsMergedReceiver(TestCase):
    ...
    def test_disabled_when_no_feature_flag(self, mock_logger: MagicMock) -> None:
        ...
        with self.settings(FLAGS={"EMAIL_MODULE": [("boolean", False)]}):
            ...
            # Assert
            mock_logger.debug.assert_called_once_with("EMAIL_MODULE feature flag not set, skipping persons_merged")
    ...
    @patch("src.emails.actions.persons_merged.immediate_action")
