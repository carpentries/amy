...
from src.emails.signals import NEW_MEMBERSHIP_ONBOARDING_SIGNAL_NAME
...
class TestRunNewMembershipOnboardingStrategy(TestCase):
    @patch("src.emails.actions.new_membership_onboarding.new_membership_onboarding_signal")
    ...
    @patch("src.emails.actions.new_membership_onboarding.new_membership_onboarding_update_signal")
    ...
    @patch("src.emails.actions.new_membership_onboarding.new_membership_onboarding_cancel_signal")
