...
class TestInstructorDeclinedFromWorkshopReceiver(TestCase):
    ...
    def test_disabled_when_no_feature_flag(self, mock_logger: MagicMock) -> None:
        ...
        with self.settings(FLAGS={"EMAIL_MODULE": [("boolean", False)]}):
            ...
            mock_logger.debug.assert_called_once_with(
                "EMAIL_MODULE feature flag not set, skipping instructor_declined_from_workshop"
            )
    ...
    @patch("src.emails.actions.instructor_declined_from_workshop.immediate_action")
