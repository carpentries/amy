...
from src.emails.utils import api_model_url, scalar_value_none, scalar_value_url
from src.extrequests.models import SelfOrganisedSubmission
from src.workshops.models import Event, Language, Organization, Tag
...
class TestNewSelfOrganisedWorkshopReceiver(TestCase):
    ...
    @patch("src.emails.actions.new_self_organised_workshop.immediate_action")
