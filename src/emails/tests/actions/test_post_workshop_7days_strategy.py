...
from src.emails.signals import POST_WORKSHOP_7DAYS_SIGNAL_NAME
...
class TestRunPostWorkshop7DaysStrategy(TestCase):
    ...
    @patch("src.emails.actions.post_workshop_7days.post_workshop_7days_update_signal")
    ...
    @patch("src.emails.actions.post_workshop_7days.post_workshop_7days_cancel_signal")
