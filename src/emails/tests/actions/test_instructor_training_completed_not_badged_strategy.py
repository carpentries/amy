...
from src.emails.signals import INSTRUCTOR_TRAINING_COMPLETED_NOT_BADGED_SIGNAL_NAME
...
class TestRunInstructorTrainingCompletedNotBadgedStrategy(TestCase):
    @patch(
        "src.emails.actions.instructor_training_completed_not_badged.instructor_training_completed_not_badged_signal",
    )
    ...
    @patch(
        "src.emails.actions.instructor_training_completed_not_badged."
        "instructor_training_completed_not_badged_update_signal",
    )
    @patch(
        "src.emails.actions.instructor_training_completed_not_badged.find_training_completion_date",
    )
