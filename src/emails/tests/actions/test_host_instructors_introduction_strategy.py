...
from src.emails.signals import HOST_INSTRUCTORS_INTRODUCTION_SIGNAL_NAME
...
class TestRunHostInstructorsIntroductionStrategy(TestCase):
    @patch(
        "src.emails.actions.host_instructors_introduction.host_instructors_introduction_signal",
    )
    ...
    @patch(
        "src.emails.actions.host_instructors_introduction.host_instructors_introduction_update_signal",
    )
    ...
    @patch(
        "src.emails.actions.host_instructors_introduction.host_instructors_introduction_cancel_signal",
    )
