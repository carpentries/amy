...
from src.emails.actions.post_workshop_7days import post_workshop_7days_receiver
...
from src.emails.signals import POST_WORKSHOP_7DAYS_SIGNAL_NAME, post_workshop_7days_signal
...
class TestPostWorkshop7DaysReceiver(TestCase):
    ...
    @patch("src.emails.actions.post_workshop_7days.get_scheduled_at")
