...
from src.workshops.tests.base import TestBase, consent_to_all_required_consents
...
class TestInstructorSignsUpForWorkshopReceiver(TestCase):
    ...
    @patch("src.emails.actions.instructor_signs_up_for_workshop.immediate_action")
