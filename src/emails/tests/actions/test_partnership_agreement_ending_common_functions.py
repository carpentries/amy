...
from src.emails.types import PartnershipAgreementEndingContext
...
class TestPartnershipAgreementEndingCommonFunctions(TestCase):
    ...
    def setUpContext(self, partnership: Partnership) -> PartnershipAgreementEndingContext:
        return {"partnership": partnership}

    @patch("src.emails.utils.datetime", wraps=datetime)
    def test_get_scheduled_at__three_months_before_agreement_end(self, mock_datetime: MagicMock) -> None:
        # Arrange
        ...
        # Assert
        self.assertEqual(scheduled_at, datetime(2023, 10, 2, 12, 0, 0, tzinfo=UTC))
    ...
    def test_get_context(self) -> None:
        ...
        # Assert
        self.assertEqual(context, {"partnership": partnership})
