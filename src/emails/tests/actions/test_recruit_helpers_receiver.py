...
from src.emails.actions.recruit_helpers import recruit_helpers_receiver
...
from src.emails.signals import RECRUIT_HELPERS_SIGNAL_NAME, recruit_helpers_signal
from src.emails.utils import api_model_url, scalar_value_none
...
class TestRecruitHelpersReceiver(TestCase):
    ...
    def test_disabled_when_no_feature_flag(self, mock_logger: MagicMock) -> None:
        ...
        with self.settings(FLAGS={"EMAIL_MODULE": [("boolean", False)]}):
            ...
            # Assert
            mock_logger.debug.assert_called_once_with("EMAIL_MODULE feature flag not set, skipping recruit_helpers")
    ...
    @patch("src.emails.actions.recruit_helpers.shift_date_and_apply_current_utc_time")
