...
from src.emails.actions.ask_for_website import ask_for_website_receiver
...
from src.emails.signals import ASK_FOR_WEBSITE_SIGNAL_NAME, ask_for_website_signal
...
class TestAskForWebsiteReceiver(TestCase):
    ...
    @patch("src.emails.actions.ask_for_website.one_month_before")
...
class TestAskForWebsiteReceiverIntegration(TestBase):
    ...
    def test_integration(self) -> None:
        ...
        instructor2 = Person.objects.create(
            ...
            mastodon="https://ohai.social/@poiuyt",
