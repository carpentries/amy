...
class TestInstructorConfirmedForWorkshopReceiver(TestCase):
    ...
    def test_disabled_when_no_feature_flag(self, mock_logger: MagicMock) -> None:
        ...
        with self.settings(FLAGS={"EMAIL_MODULE": [("boolean", False)]}):
            ...
            mock_logger.debug.assert_called_once_with(
                "EMAIL_MODULE feature flag not set, skipping instructor_confirmed_for_workshop"
            )
    ...
    @patch("src.emails.actions.instructor_confirmed_for_workshop.immediate_action")
