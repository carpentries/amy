    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "signal",
                    models.SlugField(
                        help_text="Trigger that will queue this email template", max_length=255, unique=True
                    ),
                ),
                (
                    "subject",
                ...
                (
                    "bcc_header",
                    django.contrib.postgres.fields.ArrayField(base_field=models.EmailField(max_length=255), size=None),
                ),
                (
                    "body",
                    models.TextField(
                        help_text="Enter Markdown for email body. If you need to use loops, conditions, etc., use <a "
                        "href='https://docs.djangoproject.com/en/dev/topics/templates/#the-django-template-language'>"
                        "Django templates language</a>.",
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.EmailField(max_length=254), size=None, verbose_name="To (header)"
                    ),
                ),
                ("from_header", models.EmailField(max_length=254, verbose_name="From (header)")),
                (
                    "reply_to_header",
                    models.EmailField(blank=True, default="", max_length=254, verbose_name="Reply-To (header)"),
                ),
                (
                    "cc_header",
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.EmailField(max_length=254), size=None, verbose_name="CC (header)", blank=True
                    ),
                ),
                (
                    "bcc_header",
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.EmailField(max_length=254), size=None, verbose_name="BCC (header)", blank=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scheduled_email",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="emails.scheduledemail"),
                ),
            ],
            options={
                "abstract": False,
