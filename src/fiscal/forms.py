...
from src.workshops.forms import SELECT2_SIDEBAR, BootstrapHelper, form_saved_add_comment
from src.workshops.models import Member, Membership, Organization
...
class OrganizationForm(forms.ModelForm[Organization]):
    ...
    def clean_domain(self) -> str:
        ...
        domain = unparsed_url[2:] if unparsed_url.startswith("//") else unparsed_url
