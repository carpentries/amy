...
from src.consents.exceptions import TermOptionDoesNotBelongToTermException
...
class TestConsentModel(ConsentTestBase):
    ...
    def test_term_and_term_option_should_match(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            f"Consent self.term.pk={term1.pk} must match self.term_option.term.pk={term2.pk}",
        ):
    ...
    def test_term_options(self) -> None:
        ...
        with self.assertNumQueries(2):
            ...
            term1.options  # noqa: B018
            term2.options  # noqa: B018
