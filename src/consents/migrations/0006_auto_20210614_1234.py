...
def reconsent(model_class: type[Any], old_consent: Any, term_option: Any) -> None:
...
def copy_privacy_policy(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
...
def copy_may_contact(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    Consent = apps.get_model("consents", "Consent")
    TermOption = apps.get_model("consents", "TermOption")
...
def copy_public_profile(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    Consent = apps.get_model("consents", "Consent")
    TermOption = apps.get_model("consents", "TermOption")
...
def copy_may_publish_name(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    Consent = apps.get_model("consents", "Consent")
    TermOption = apps.get_model("consents", "TermOption")
