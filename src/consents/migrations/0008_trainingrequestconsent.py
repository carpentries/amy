    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "term_option",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to="consents.termoption"),
                ),
                (
                    "training_request",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="workshops.trainingrequest"),
                ),
            ],
        ),
