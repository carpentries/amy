...
def create_preexisting_terms(apps, schema_editor) -> None:
    ...
    user_privacy_policy_agree = TermOption.objects.create(term=user_privacy_policy, option_type=AGREE)
    may_contact = Term.objects.create(
        content="May contact",
        slug="may-contact",
        required_type=PROFILE_REQUIRE_TYPE,
        help_text="Allow to contact from The Carpentries according to the Privacy Policy.",
    )
    may_contact_agree = TermOption.objects.create(term=may_contact, option_type=AGREE)
    may_contact_disagree = TermOption.objects.create(term=may_contact, option_type=DECLINE)
    ...
    public_profile_agree = TermOption.objects.create(term=public_profile, option_type=AGREE)
    public_profile_disagree = TermOption.objects.create(term=public_profile, option_type=DECLINE)
    may_publish_name = Term.objects.create(
        content="Do you consent to have your name or identity associated with lesson publications?",
    ...
    may_publish_name_disagree = TermOption.objects.create(term=may_publish_name, option_type=DECLINE)
