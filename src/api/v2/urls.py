...
router.register("accountbenefit", views.AccountBenefitViewSet)
router.register("benefit", views.BenefitViewSet)
router.register("consortium", views.ConsortiumViewSet)
router.register("curriculum", views.CurriculumViewSet)
