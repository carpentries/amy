...
from src.workshops.forms import SELECT2_SIDEBAR, bootstrap_helper_filter
...
def extend_country_choices(choices: Sequence[str], countries_override: dict[str, Any]) -> list[str | tuple[str, Any]]:
    ...
    """
    countries: list[str | tuple[str, str]] = list(choices)
