...
from src.workshops.filters import filter_taught_workshops
from src.workshops.forms import PersonForm, PersonsMergeForm
...
@patch("src.workshops.github_auth.github_username_to_uid", lambda username: None)
...
class TestPersonMerging(TestBase):
    def setUp(self) -> None:
        ...
        self.person_a_consent_privacy_policy.created_at = datetime(2023, 4, 10, tzinfo=UTC)
        ...
        self.person_a_consent_may_contact.created_at = datetime(2023, 4, 11, tzinfo=UTC)
        ...
        self.person_a_consent_public_profile.created_at = datetime(2023, 4, 11, tzinfo=UTC)
        ...
        self.person_a_consent_may_publish_name.created_at = datetime(2023, 4, 10, tzinfo=UTC)
        ...
        self.person_b_consent_privacy_policy.created_at = datetime(2023, 4, 11, tzinfo=UTC)
        ...
        self.person_b_consent_may_contact.created_at = datetime(2023, 4, 10, tzinfo=UTC)
        ...
        self.person_b_consent_public_profile.created_at = datetime(2023, 4, 10, tzinfo=UTC)
        ...
        self.person_b_consent_may_publish_name.created_at = datetime(2023, 4, 11, tzinfo=UTC)
    ...
    def test_merging_relational_attributes(self) -> None:
        ...
        assertions = {
            ...
            "languages": {
                Language.objects.all()[0],
                Language.objects.all().reverse()[0],
            },
...
@patch("src.workshops.github_auth.github_username_to_uid", github_username_to_uid_mock)
class TestPersonAndUserSocialAuth(TestBase):
    ...
    def test_errors_are_not_hidden(self) -> None:
        ...
        self._setUpUsersAndLogin()
        with (
            patch.object(Person, "synchronize_usersocialauth", side_effect=NotImplementedError),
