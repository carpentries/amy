...
def add_new_curricula(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
...
def add_curricula_descriptions(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    Curriculum = apps.get_model("workshops", "Curriculum")
    ECOLOGY = (
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True,
                default="",
                help_text="You can enter Markdown. It will be shown as a hover or popup over the curriculum entry on "
                "forms.",
                max_length=400,
