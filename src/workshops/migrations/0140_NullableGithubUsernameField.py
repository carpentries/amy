...
def display_wrong_gh_usernames(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    Person = apps.get_model("workshops", "Person")

    persons = Person.objects.annotate(github_length=Length("github")).order_by("family", "personal")
    ...
    if persons:
        ...
        for person in persons:
            print(f"{str(person)} ({person.personal} {person.family}):\t{person.github}")
