...
def set_data_privacy_agreement(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    cutoff_date = datetime(2016, 11, 11, tzinfo=UTC)
...
def set_teaching_frequency_expectation(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    TrainingRequest.objects.filter(teaching_frequency_expectation="often").update(
        teaching_frequency_expectation="other", teaching_frequency_expectation_other="Often (primary occupation)"
    )
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                verbose_name="I agree to abide by The Carpentries' Code of Conduct. The Code of Conduct can be "
                'found at <a href="http://software-carpentry.org/conduct/">http://software-carpentry.org/conduct/'
                '</a> and <a href="http://datacarpentry.org/code-of-conduct/">http://datacarpentry.org/code-of-'
                "conduct/</a>.",
            ),
        ),
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                verbose_name='I have read and agree to <a href="https://software-carpentry.org/privacy/", '
                'target="_blank">the Software Carpentry Foundation\'s data privacy policy</a>.',
            ),
        ),
        migrations.AddField(
            model_name="trainingrequest",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                ...
                ' completion steps are described at <a href="http://carpentries.github.io/instructor-training/'
                'checkout/">http://carpentries.github.io/instructor-training/checkout/</a> and take a total of '
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                max_length=255,
                null=True,
                verbose_name="I self-identify as a member of a group that is under-represented in research and/or"
                " computing, e.g., women, ethnic minorities, LGBTQ, etc.",
            ),
        ),
        migrations.AddField(
            model_name="trainingrequest",
            ...
            field=models.BooleanField(
                default=False,
                help_text="The Carpentries strive to make workshops accessible to as many people as possible, in as"
                " wide a variety of situations as possible.",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                verbose_name="I agree to teach a Carpentry workshop within 12 months of this Training Course.",
            ),
        ),
