...
def update_link_for_existing_curriculums(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name="website",
            field=models.URLField(blank=True, default="", verbose_name="Curriculum page"),
        ),
        migrations.RunPython(update_link_for_existing_curriculums, migrations.RunPython.noop),
    ]
