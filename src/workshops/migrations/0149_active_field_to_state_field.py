...
def determine_entry_state(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    DCSelfOrganizedEventRequest = apps.get_model("workshops", "DCSelfOrganizedEventRequest")
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                blank=True,
                default=False,
                help_text="The Carpentries strive to make workshops accessible to as many people as possible, in "
