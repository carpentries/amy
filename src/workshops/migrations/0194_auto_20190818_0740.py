...
def migrate_travel_exp_management(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    WorkshopRequest.objects.filter(travel_expences_management="").update(travel_expences_management="other")
...
def migrate_institutional_restrictions(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    to a new contents ("other")."""
    WorkshopRequest = apps.get_model("workshops", "WorkshopRequest")
    WorkshopRequest.objects.filter(institution_restrictions="").update(institution_restrictions="other")
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                " have citizenship or other requirements for employees or volunteers who facilitate workshops. "
                "If your institution fits this description, please share your requirements or note that there "
                "are no restrictions.",
            ),
        ),
