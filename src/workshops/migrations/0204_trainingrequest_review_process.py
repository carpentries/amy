...
def update_trainingrequest_review_process(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[("preapproved", "Pre-approved Registration"), ("open", "Open Training Application")],
                default="",
                max_length=20,
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                default="",
                help_text="If you have been given a registration code through a Carpentries member site or for a"
                " specific scheduled event, please enter it here:",
                max_length=100,
