...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(
                blank=True, help_text="Public instructor training seats rolled over into next membership.", null=True
            ),
        ),
        migrations.AddField(
            model_name="membership",
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                blank=True,
                help_text="In-house instructor training seats rolled over from previous membership.",
                null=True,
            ),
        ),
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                blank=True, help_text="In-house instructor training seats rolled over into next membership.", null=True
            ),
        ),
        ...
        #     model_name='membership',
        #     name='public_status',
        #     field=models.CharField(choices=[('public', 'Public'), ('private', 'Private')], default='private',
        #        help_text='Public memberships may be listed on any of The Carpentries websites.', max_length=20,
