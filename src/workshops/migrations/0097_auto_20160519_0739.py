...
def populate_languages(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    """
    with open("src/workshops/migrations/data/registry.json", encoding="utf-8") as f:
    ...
    for language in languages:
        if language["Type"] == "language" and len(language["Subtag"]) <= 2:
            ...
            Language.objects.get_or_create(name=" ".join(language["Description"])[:40], subtag=language["Subtag"])
