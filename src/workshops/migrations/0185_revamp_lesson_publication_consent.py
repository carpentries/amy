...
def change_default_for_existing_users(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                default="unset",
                help_text="When we publish our lessons, we like to include everyone who has contributed via pull"
                " request as an author. If you do make any contributions, would you like to be included as an author"
                " when we publish the lesson?",
                max_length=40,
                verbose_name="Do you consent to have your name or identity associated with lesson publications?",
            ),
        ),
