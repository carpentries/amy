    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                default=0,
                help_text="Use this field if you want to grant more seats than the agreement provides for.",
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(
                default=0, help_text="Number of seats in instructor trainings", verbose_name="Instructor training seats"
            ),
        ),
    ]
