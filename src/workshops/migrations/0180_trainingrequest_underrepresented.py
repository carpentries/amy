...
def fill_underrepresented(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[("yes", "Yes"), ("no", "No"), ("undisclosed", "Prefer not to say")],
                default="undisclosed",
                help_text="The Carpentries strives to increase opportunities for underrepresented groups to join our"
                " team.",
                max_length=20,
