...
def migrate_lesson_contributions_to_involvements(apps, schema_editor) -> None:
    ...
    TrainingProgress.objects.filter(requirement__name="Lesson Contribution").update(
...
def migrate_involvements_to_lesson_contributions(apps, schema_editor) -> None:
    ...
    TrainingProgress.objects.filter(involvement_type__name="GitHub Contribution").update(
