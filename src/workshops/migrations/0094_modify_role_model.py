...
def update_roles(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    try:
        ...
        Role.objects.create(name="contributor", verbose_name="Contributed to lesson materials")
