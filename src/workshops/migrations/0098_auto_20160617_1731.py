...
def add_topics(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    DCWorkshopTopic = apps.get_model("workshops", "DCWorkshopTopic")

    topics = [
        "Data organization - Ecology spreadsheets, Genomics project organization or Geospatial introduction to data",
        "Ecology R",
        "Ecology Python",
        "Ecology SQL",
...
def add_domains(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
