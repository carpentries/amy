...
from src.extforms.forms import WorkshopRequestExternalForm
from src.workshops.models import Curriculum, InfoSource, Language, WorkshopRequest
...
class TestWorkshopRequestExternalForm(TestBase):
    ...
    def test_request_added(self) -> None:
        ...
        rv = self.client.post(reverse("workshop_request"), data, follow=True)
