...
def change_knowledgedomain_names(apps, schema_editor):
    ...
    Change "Civil, mechanical, or chemical engineering" → "Civil, mechanical, chemical, or nuclear engineering".
    ...
    KnowledgeDomain.objects.filter(name='Civil, mechanical, or chemical engineering').update(name='Civil, mechanical, chemical, or nuclear engineering')
