    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendee_domains_other', models.CharField(blank=True, default='', max_length=100)),
