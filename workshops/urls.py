...
urlpatterns = [
    ...
    url(r'membership/(?P<membership_id>\d+)/delete', views.MembershipDelete.as_view(), name='membership_delete'),
    ...
    url(r'^person/(?P<person_id>\d+)/delete$', views.PersonDelete.as_view(), name='person_delete'),
    ...
    url(r'^event/(?P<slug>[\w-]+)/delete$', views.EventDelete.as_view(), name='event_delete'),
    ...
    url(r'^todo/(?P<todo_id>\d+)/delete', views.TodoDelete.as_view(), name='todo_delete'),
]
