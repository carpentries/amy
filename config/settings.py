...
env = environ.Env(
    ...
    AMY_SERVER_LOGFILE=(str, str(ROOT_DIR / "logs" / "amy.log")),
    AMY_DEBUG_LOGFILE=(str, str(ROOT_DIR / "logs" / "amy_debug.log")),
    AMY_WORKER_LOGFILE=(str, str(ROOT_DIR / "logs" / "worker_debug.log")),
