    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "cr/<int:content_type_id>/<int:object_id>/",
                    login_required(shortcut),
...
redirect_urlpatterns = [
    ...
    path(
        ...
        RedirectView.as_view(pattern_name="admin-dashboard"),
    ),
    path(
    ...
    path(
        ...
        RedirectView.as_view(pattern_name="training-progress"),
    ),
    path(
        "workshops/autoupdate_profile/",
        RedirectView.as_view(pattern_name="autoupdate_profile"),
    ),
    path(
        "workshops/training_requests/",
        RedirectView.as_view(pattern_name="all_trainingrequests"),
    ),
    path(
        "workshops/training_requests/merge",
        RedirectView.as_view(pattern_name="trainingrequests_merge"),
    ),
    path(
        "workshops/bulk_upload_training_request_scores",
        RedirectView.as_view(pattern_name="bulk_upload_training_request_scores"),
    ),
    path(
    ...
    path(
        ...
        RedirectView.as_view(pattern_name="all_workshoprequests"),
    ),
    path(
    ...
    path(
        "workshops/reports/workshop_issues/",
        RedirectView.as_view(pattern_name="workshop_issues"),
    ),
    path(
        "workshops/reports/instructor_issues/",
        RedirectView.as_view(pattern_name="instructor_issues"),
    ),
    path(
        "workshops/reports/duplicate_persons/",
        RedirectView.as_view(pattern_name="duplicate_persons"),
    ),
    path(
        "workshops/reports/duplicate_training_requests/",
        RedirectView.as_view(pattern_name="duplicate_training_requests"),
    ),
