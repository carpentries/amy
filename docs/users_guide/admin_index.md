...
* **Extensions** [Extensions to the membership end date](#extending-membership-dates) are created using the "Extend" button at the bottom of the main membership page. The duration of the extension can be edited here.
